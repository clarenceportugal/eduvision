...
class PendingProgramChairScreen extends StatefulWidget {
  final Map<String, dynamic> userData;

  const PendingProgramChairScreen({super.key, required this.userData});

  @override
  State<PendingProgramChairScreen> createState() => _PendingProgramChairScreenState();
}

class _PendingProgramChairScreenState extends State<PendingProgramChairScreen>
  ...
  Widget _buildHeader() {
    return Column(
      ...
      children: [
        Text(
          'Pending Programchairperson${collegeName.isNotEmpty ? ' - ${collegeName.toUpperCase()}' : ''}',
