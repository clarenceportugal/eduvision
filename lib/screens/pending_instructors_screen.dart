...
class PendingInstructorsScreen extends StatefulWidget {
  final Map<String, dynamic> userData;

  const PendingInstructorsScreen({super.key, required this.userData});

  @override
  State<PendingInstructorsScreen> createState() => _PendingInstructorsScreenState();
}

class _PendingInstructorsScreenState extends State<PendingInstructorsScreen>
